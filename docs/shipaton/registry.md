...
| **Hosted MCP as the front door** (distribution) | 🔵 **4 PRs open** — #528 scope · #529 public tier (no key: `preview_app` + `proof`) · #530 docs · #531 registry manifest (unpublished) | Found 2026-09-05: `POST /mcp` had been live since #93 while `docs/prd/mcp-server.md` said "deferred"; the route sat behind login. Loop scope + exit criteria: PR #528 |
